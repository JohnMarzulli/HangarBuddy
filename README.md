...
|-------------------|----------------------|----------------------|----------------------------|----------------------------|-------------------|
| MQ2 VCC (white)   | TSL2591 VCC (white)  |                      | Pin 1 — 3V3 Power          | Pin 2 — 5V Power           | Display VCC (red) |
...
|                   |                      | DHT22 VCC (white)    | Pin 17 — 3V3 Power         | Pin 18 — GPIO24            |                   |
...
| Red        | +5V              | VCC        |
| Black      | GND              | GND        |
| White      | SDA/GPIO2/Phys 3 | SDA        |
| Gray       | SCL/GPIO3/Phys 5 | SCL        |
